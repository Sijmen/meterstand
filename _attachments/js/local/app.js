...
$(function() {
    ...
    var gauge;
    var historyChart;
    var barPlot = new BarPlot('history_chart_div',oDB);
    var livePlot = new LivePlot('chart_div',oDB);
    var generalOptions = {
                            curveType: "function",
                            height:300,
                            // width:"90%",
    ...
    function onPageSwitch(sPage){
        switch(sPage){
            case '#overview':
                ...
                var hourPlot = new BarPlot('hour_div',oDB);
                var dayPlot = new BarPlot('day_div',oDB);
                var monthPlot = new BarPlot('month_div',oDB);
                vSetLoad($('#hour_div'));
                vSetLoad($('#day_div'));
                vSetLoad($('#month_div'));
                today = new Date();
