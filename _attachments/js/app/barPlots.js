...
function BarPlot(elementID,oDB,sDesign){
    ...
    var oBarOptions = {bar:{groupWidth:"90%"},isStacked: true,series: [{color: '#004FB5', visibleInLegend: true}, {color: '#002D93', visibleInLegend: false}]};
    ...
    */
    function vCleanGraphData(sLabel,iColnum){
            ...
            success : function(data) {
                ...
                $.each(data.rows,function(key,value){
                    ...
                    if(oDate.getDay() == 0 || oDate.getDay() == 6)
                        graphData.addRows([[oDate,0,iValue]]);
                    else
                        graphData.addRows([[oDate,iValue,0]]);
    ...
    function vLoadUnixTimestamp(oStartDate,oEndDate){
        ...
        oDB.view(sDesign + "/time", {
            ...
            success : function(data) {
                ...
                $.each(data.rows,function(key,value){
                    graphData.addRows([[new Date(value.key*1000),Math.round(value.value.watt),0]]);
                });
                $('#'+elementID).html('');
                chart.draw(graphData,oBarOptions);
            }
